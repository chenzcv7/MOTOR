...
from vqa_api.dataset_slake_2 import VQAFeatureDataset,SLAKEDataset
from vqa_api.multi_level_model_slake import BAN_Model
from vqa_api.train_slake import train
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', default='./configs/vqa_new.yaml')
    ...
    model = BAN_Model(train_dataset, args, config, tokenizer)
